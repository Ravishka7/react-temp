    ...
    return (
        <section className="py-8 px-16">
            <div className="grid grid-cols-2 rounded-md min-h-[60vh] bg-[#f4f8f9]">
                <div className="flex flex-col justify p-20 gap-y-4">
                ...
                <div className="relative">
                    <img src="/assets/tour/tour_1.jpg" alt="" className="w-full h-full object-cover"/>
                </div>
                <div className="relative">
                    <img src="/assets/tour/tour_2.jpg" alt="" className="w-full h-full object-cover"/>
                </div>
